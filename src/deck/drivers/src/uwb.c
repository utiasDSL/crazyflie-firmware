...
// This file is moved from the UWB anchor and is similar to locodeck.c 
// It is necessary to keep this one since this file create a task to ranging between anchors (CFs).
// but keep both locodeck.c and uwb.c may cause problems due to name overlapping

#include <stm32f0xx_hal.h>   // [problem]
...
void uwbInit()
{
  ...
  dwOpsInit(dwm);                  // defined in "dwOps.h"
